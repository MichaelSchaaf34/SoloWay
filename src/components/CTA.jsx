...
const CTA = () => {
  ...
  return (
    <section id="community" className="py-24 md:py-28 bg-slate-100 dark:bg-slate-900">
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-slate-900 to-slate-800 dark:from-teal-900 dark:to-slate-900 rounded-3xl border border-slate-700/50 p-8 sm:p-10 md:p-12 text-white shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-5 relative z-10">
          ...
          >
            <input 
              ...
              required
              className="flex-1 px-6 py-3.5 rounded-full bg-white/10 border border-white/20 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500 backdrop-blur-sm"
            />
            <button 
              type="submit"
              disabled={isSubmitting}
              className="px-8 py-3.5 rounded-full bg-white text-slate-900 font-bold hover:bg-teal-50 disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
            >
